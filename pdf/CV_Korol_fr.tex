...
4\textsuperscript{e} Symposium \href{https://cemdi.ca/symposium.php?id=evt_4th_symposium_2026}{CEMDI--PAIMS}, Université McGill, Montréal, Québec \hfill{2026}

\begin{list1}
\item[]\underline{Présentation invitée :} ``Illuminating Materials by Computations: Characterization of Beyond-Dipole Effects and Signatures of Time Crystals"
\item[]Président de session (Solid-State Ionics)
\end{list1}

\vspace*{-1mm}

\href{https://www.cheminst.ca/conference/x2026/}{Congrès et exposition de chimie canadienne}, Toronto, Ontario \hfill{2026}

\begin{list1}
\item[]\underline{Présentation invitée :} ``A window to Earth's past with the help of theoretical chemistry"
\item[]Présentation orale : ``How NOT to build control-target gates in semiconductor quantum dots and beyond"
\end{list1}

\vspace*{-1mm}

Session générale de chimie physique, théorique et computationnelle (\href{https://www.cheminst.ca/physical-theoretical-and-computational-division-ptc/}{PTC}), Toronto, Ontario \hfill{2026}

\begin{list1}
\item[]Président de session
\end{list1}

\vspace*{-1mm}

Séminaire CQIQC, Université de Toronto, Toronto, Ontario \hfill{2026}

\begin{list1}
\item[]\underline{Présentation invitée :} ``How NOT to build control-target gates in semiconductor quantum dots and beyond"
\end{list1}
...
Société canadienne de chimie (\href{https://www.cheminst.ca/about/about-csc/}{SCC})\\
Division de chimie physique, théorique et computationnelle (\href{https://www.cheminst.ca/physical-theoretical-and-computational-division-ptc/}{PTC}) de la SCC\\
Association canadienne des chimistes théoriques (\href{http://www.catc.ca/members}{ACCT})\\
\href{https://www.usherbrooke.ca/iq/fr/a-propos/equipe/corps-professoral/roman-korol}{Institut Quantique} de l'Université de Sherbrooke\\
Centre de recherche en modélisation moléculaire (\href{https://www.concordia.ca/research/molecular-modeling.html}{CERMM})\\
Centre d'études des matériaux avancés pour les piles et systèmes de stockage d'énergie renouvelable de l'Université de Sherbrooke (\href{https://www.usherbrooke.ca/recherche/fr/udes/regroupements/centres}{CÉMAPROVUS})

\section{\sc Bénévolat et \\Initiatives Communautaires}
Direction et coordination de l'envoi de fournitures humanitaires en Ukraine \href{https://www.caltech.edu/about/news/organizing-aid-to-his-native-ukraine}{\faIcon{external-link-alt}}\hfill{2022--2023}
