...
\usepackage[T1]{fontenc} % Ajout pour les caractères français
...
\name{\vspace{-1.9cm}\huge{Roman Korol \href{https://korolgroup.github.io/fr/index.html}{\faExternalLink*}\;\;\href{https://scholar.google.com.ua/citations?hl=en&user=YAAMduoAAAAJ}{\faGraduationCap}\;\;\href{https://orcid.org/0000-0002-9275-5897}{\faOrcid}\;\;\href{https://github.com/korolgroup}{\faGithub} \vspace*{.1in}}
...
\vspace{-5mm}
\hspace{1in} Université de Rochester
...
\end{list1}
\section{\sc Poste \\À Venir}
{\bf Université de Sherbrooke}, Sherbrooke, Québec, Canada\\
\vspace*{-.1in}
\begin{list1}
\item[] Professeur adjoint, à partir de janvier 2026
\end{list1}
...
Revues APS : Physical Review Letters, Physical Review A, B, et E\\
...
\section{\sc Autre Expérience \\Professionnelle}
Enseignant au secondaire, Rotman Arts and Science School, Vaughan, Canada \hfill{2020--2022}
